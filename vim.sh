...
## ----- Skipping compilation of vim from source
## ----- Because I'm using spacemacs instead and this is needed only for YCM
...
## ----- Skipping YouCompleteMe setup for now
## ----- Because I'm using spacemacs instead and this takes way too long
